...
(function weatherZone() {
  ...
  var BG_MAP = {
    Clear: 'images/sunny.jpeg', Clouds: 'images/cloudy.jpeg',
    Rain: 'images/Rainy.jpeg', Drizzle: 'images/Rainy.jpeg',
    Thunderstorm: 'images/Rainy.jpeg', Snow: 'images/snow.jpeg',
    Mist: 'images/cloudy.jpeg', Haze: 'images/cloudy.jpeg', Fog: 'images/cloudy.jpeg'
  };
  function setBg(main) {
    var wzSky = document.getElementById('wzSky');
    if (!wzSky) return;
    wzSky.style.backgroundImage = 'url(' + (BG_MAP[main] || 'images/Paris.avif') + ')';
